...
def check_task_101():
    print(f"\nТестирование Задание 101: Расстояние между точками")
    test_cases = [
        ("0\n0\n3\n4", 5.0),
        ("-1\n1\n2\n5", 5.0),
        ("1\n1\n1\n4", 3.0),
    ...
    for i, (input_data, expected) in enumerate(test_cases, 1):
        output, error = run_script("Задание 101.py", input_data)
...
def check_task_102():
    print(f"\nТестирование Задание 102: Площадь треугольника")
    test_cases = [
        ("0\n0\n3\n0\n0\n4", 12.0, 6.0),
        ("1\n1\n2\n5\n5\n3", 12.2, 7.0),
        ("0\n0\n10\n0\n5\n5", 24.14, 25.0),
    ...
    for i, (input_data, exp_perimeter, exp_area) in enumerate(test_cases, 1):
        output, error = run_script("Задание 102.py", input_data)
...
if __name__ == '__main__':
    success_11 = check_task_101()
    success_12 = check_task_102()
